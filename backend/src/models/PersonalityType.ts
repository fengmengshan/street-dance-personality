import { PersonalityType, DanceStyle, DimensionScores } from '../types'
...
export const personalityTypes: PersonalityType[] = [
  {
    ...
    recommendedStyles: [DanceStyle.POPPING, DanceStyle.LOCKING, DanceStyle.ANIMATION],
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.HIPHOP, DanceStyle.HOUSE, DanceStyle.KRUMP],
    developmentSuggestions: [
      '参加更多Cypher活动',
      '尝试不同音乐类型',
      '与其他艺术形式结合',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.BREAKING, DanceStyle.VOGUING, DanceStyle.WAACKING],
    developmentSuggestions: [
      '尝试融合不同舞种',
      '参与国际交流',
      '学习舞蹈历史',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.POPPING, DanceStyle.ROBOT, DanceStyle.ANIMATION],
    developmentSuggestions: [
      '学习音乐制作',
      '研究不同音乐风格',
      '与音乐人合作',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.LOCKING, DanceStyle.WAACKING, DanceStyle.VOGUING],
    developmentSuggestions: [
      '学习经典动作',
      '研究大师作品',
      '开发教学能力',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.HIPHOP, DanceStyle.KRUMP, DanceStyle.HOUSE],
    developmentSuggestions: [
      '参与更多表演',
      '发展领导能力',
      '组织社区活动',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.ANIMATION, DanceStyle.ROBOT, DanceStyle.POPPING],
    developmentSuggestions: [
      '增加表达机会',
      '参与小组活动',
      '分享观察心得',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.HOUSE, DanceStyle.HIPHOP, DanceStyle.LOCKING],
    developmentSuggestions: [
      '发展领导技能',
      '学习团队管理',
      '组织团队活动',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.BREAKING, DanceStyle.KRUMP, DanceStyle.VOGUING],
    developmentSuggestions: [
      '参加更多比赛',
      '发展表演技巧',
      '学习舞台艺术',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.POPPING, DanceStyle.ANIMATION, DanceStyle.ROBOT],
    developmentSuggestions: [
      '平衡技巧与表达',
      '学习放松技巧',
      '尝试即兴创作',
  ...
  },
  {
    ...
    recommendedStyles: [DanceStyle.HOUSE, DanceStyle.WAACKING, DanceStyle.VOGUING],
    developmentSuggestions: [
      '学习不同文化',
      '参与国际交流',
      '创造融合作品',
